...
public class MurderOfCrows {
    ...
    private void findTheDiamond() {
        ...
        System.out.println(theMurder.get(0).getStomachContents());
        System.out.println(theMurder.get(1).getStomachContents());
        System.out.println(theMurder.get(2).getStomachContents());
        System.out.println(theMurder.get(3).getStomachContents());
        System.out.println(theMurder.get(4).getStomachContents());
